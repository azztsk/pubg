...
function Precache( context )
    ...
    --Cache new particles
		...
		PrecacheResource("soundfile", "soundevents/game_sounds_custom.vsndevts", context )
 		PrecacheResource("model", "models/gameplay/breakingcrate.vmdl", context )
 
 
	--Cache particles for traps
	PrecacheUnitByNameSync("npc_dota_chest1", context)
	PrecacheUnitByNameSync("npc_dota_chest2", context)
	PrecacheUnitByNameSync("npc_dota_chest", context)
	PrecacheUnitByNameSync("npc_dota_wd", context)
