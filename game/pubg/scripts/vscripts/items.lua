...
function HealthTomeUsed( event )
    ...
    if picker:HasModifier("tome_health_modifier") == false then
        ...
        picker:SetModifierStackCount("tome_health_modifier", picker, 1)
        picker.HealthTomesStack = 0
    else
        picker:SetModifierStackCount("tome_health_modifier", picker, (picker:GetModifierStackCount("tome_health_modifier", picker) + 1))
    end
